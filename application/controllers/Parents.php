...
class Parents extends CI_Controller
{
    ...
    function marks($param1 = '', $exam_id = '')
    {
        ...
        $page_data['page_title'] = get_phrase('Marks For');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function invoice($student_id = '' , $param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('invoice/payment');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function transport($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('transport');
        $this->load->view('backend/index', $page_data);
    ...
    function dormitory($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title']  = get_phrase('Residence Hall');
        $this->load->view('backend/index', $page_data);
    ...
    function document($do = '', $document_id = '')
    {
        ...
        $page_data['page_title'] = get_phrase('study_documents/Homework');
