...
?>
 ...
 <?php endforeach;?>
              ...
              <?php if($class_level=='o'){ ?>  AGGREGATE :  <input style="border-bottom:1px dotted #2182C0; width:300px;" class="no-border-top no-border-left no-border-right" value="&nbsp <?php echo $total_agree;?>"/>
				&nbsp;&nbsp;  DIVISION: <input style="border-bottom:1px dotted #2182C0; width:200px;" class="no-border-top no-border-left no-border-right" value="&nbsp <?php  echo $this->crud_model->get_division($total_agree,$class_level);?>"/>
                    <br/><br/>
